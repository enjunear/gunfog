...
- `CONTEXT.md` is the glossary and the authoritative vocabulary (prose, sentence, word, complex word, placeholder word, remainder fragment, contribution, hotspot, complex list, sanitising, target, floor). 
